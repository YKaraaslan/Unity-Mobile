...
public class TensionControl extends AppCompatActivity implements WebGuideCallBack {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tension_control);
        Slidr.attach(this);
    ...
    private void init() {
        for (int i = 0; i < 10; i++) {
            webGuideList.add(new WebGuideItems(R.drawable.unity, "Gergi Kontrol Sistemleri"));
        }
    }
    ...
    public void onItemClick(int position, ImageView imageContainer, TextView name) {
        if (order) {
            ...
            Intent intent = new Intent(TensionControl.this, TensionControlProductOrders.class);
