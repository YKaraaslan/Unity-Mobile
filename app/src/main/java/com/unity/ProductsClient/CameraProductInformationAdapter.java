...
public class CameraProductInformationAdapter extends RecyclerView.Adapter<CameraProductInformationAdapter.RecyclerViewHolder>{
    List<CameraProductInformationItems> productInformationItemsList;
    Context context;
    CameraProductInformationCallBack callBack;

    public CameraProductInformationAdapter(Context context, List<CameraProductInformationItems> productInformationItemsList, CameraProductInformationCallBack callBack){
    ...
    public RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new CameraProductInformationAdapter.RecyclerViewHolder(view);
    }
