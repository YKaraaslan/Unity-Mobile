...
public class WebGuide extends AppCompatActivity implements WebGuideCallBack  {
    Toolbar toolbar;
    ...
    private void init() {
        for (int i = 0; i < 10; i++){
            webGuideList.add(new WebGuideItems(R.drawable.unity, "Kenar Kontrol Sistemleri"));
        }
    }
    ...
    public void onItemClick(int position, ImageView imageContainer, TextView name) {
        if(order){
            ...
            Intent intent = new Intent(WebGuide.this, WebGuideProductOrders.class);
