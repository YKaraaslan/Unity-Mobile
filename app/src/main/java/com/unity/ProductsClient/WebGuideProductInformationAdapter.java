...
public class WebGuideProductInformationAdapter extends RecyclerView.Adapter<WebGuideProductInformationAdapter.RecyclerViewHolder> {
    List<WebGuideProductInformationItems> productInformationItemsList;
    Context context;
    WebGuideProductInformationCallBack callBack;

    public WebGuideProductInformationAdapter(Context context, List<WebGuideProductInformationItems> productInformationItemsList, WebGuideProductInformationCallBack callBack){
    ...
    public RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new WebGuideProductInformationAdapter.RecyclerViewHolder(view);
    }
