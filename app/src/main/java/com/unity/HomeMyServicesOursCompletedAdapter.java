...
public class HomeMyServicesOursCompletedAdapter extends RecyclerView.Adapter<HomeMyServicesOursCompletedAdapter.RecyclerViewHolder> {
    List<HomeMyServicesOursCompletedItems> contactList;
    HomeMyServicesOursCompletedCallBack callBack;
    Context context;

    public HomeMyServicesOursCompletedAdapter(Context context, List<HomeMyServicesOursCompletedItems> contactList, HomeMyServicesOursCompletedCallBack callBacks) {
    ...
    public RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_home_my_services_ours_recycler_view, parent, false);
