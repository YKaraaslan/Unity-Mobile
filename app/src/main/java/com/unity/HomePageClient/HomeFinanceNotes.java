...
import com.unity.AssignmentNotesAdapter;
import com.unity.AssignmentNotesAdd;
import com.unity.AssignmentNotesCallBack;
import com.unity.AssignmentNotesItems;
import com.unity.AssignmentNotesSeenBy;
import com.unity.AssignmentNotesSeenByItems;
import com.unity.R;
...
public class HomeFinanceNotes extends AppCompatActivity implements AssignmentNotesCallBack {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_finance_notes);
        Slidr.attach(this);
        ...
        fab.setOnClickListener(view1 -> {
            Intent intent = new Intent(this, HomeFinanceNotesAdd.class);
    ...
    private void setSeen() {
        ...
        CollectionReference collectionReference = db.collection("Assignments").document(String.valueOf(getIntent().getIntExtra("id", 0))).collection("NotesFinance");
    ...
    private void openSeenBy(int id) {
        ...
        intentForActivity.putExtra("finance", true);
    ...
    private void delete(int id) {
        ...
        builder.setMessage(R.string.are_you_sure_to_delete).setPositiveButton(getString(R.string.yes), (dialogInterface, i) -> {
            ...
            DocumentReference documentReference = db.collection("Assignments").document(String.valueOf(getIntent().getIntExtra("id", 0))).collection("NotesFinance")
