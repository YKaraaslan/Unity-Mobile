...
public class HomeMyOrdersAdapter extends RecyclerView.Adapter<HomeMyOrdersAdapter.RecyclerViewHolder> {
    List<HomeMyOrdersItems> contactList;
    HomeMyOrdersCallBack callBack;
    Context context;

    public HomeMyOrdersAdapter(Context context, List<HomeMyOrdersItems> contactList, HomeMyOrdersCallBack callBacks) {
    ...
    public RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_home_my_orders_recycler_view, parent, false);
