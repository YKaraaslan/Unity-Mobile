...
public class HomeMyServicesCompletedAdapter extends RecyclerView.Adapter<HomeMyServicesCompletedAdapter.RecyclerViewHolder> {
    List<HomeMyServicesCompletedItems> contactList;
    HomeMyServicesCompletedCallBack callBack;
    Context context;

    public HomeMyServicesCompletedAdapter(Context context, List<HomeMyServicesCompletedItems> contactList, HomeMyServicesCompletedCallBack callBacks) {
    ...
    @Override
    public void onBindViewHolder(@NonNull HomeMyServicesCompletedAdapter.RecyclerViewHolder holder, int position) {
