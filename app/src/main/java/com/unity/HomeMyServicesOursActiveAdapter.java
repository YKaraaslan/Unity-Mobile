...
public class HomeMyServicesOursActiveAdapter extends RecyclerView.Adapter<HomeMyServicesOursActiveAdapter.RecyclerViewHolder> {
    List<HomeMyServicesOursActiveItems> contactList;
    HomeMyServicesOursActiveCallBack callBack;
    Context context;

    public HomeMyServicesOursActiveAdapter(Context context, List<HomeMyServicesOursActiveItems> contactList, HomeMyServicesOursActiveCallBack callBacks) {
